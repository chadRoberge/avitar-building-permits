...
const permitMessageSchema = new mongoose.Schema({
  ...
  messageType: {
    type: String,
    enum: ['general', 'question', 'request_info', 'status_update', 'approval', 'rejection', 'system_notification'],
    default: 'general'
  },
...
permitMessageSchema.statics.getPermitMessages = function(permitId, userType = 'residential') {
