...
export default class ResidentialContractorsController extends Controller {
  @service router;
  ...
  get userMunicipality() {
    return this.model?.userMunicipality;
  }
  ...
  @action
  async selectUserMunicipality() {
    if (this.userMunicipality) {
      await this.selectMunicipality(this.userMunicipality);
    }
  }
